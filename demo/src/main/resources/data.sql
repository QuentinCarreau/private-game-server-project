...
INSERT INTO game_servers (id, game_server_name, game_server_status, ip_adress, port, game_server_pwd, saved_world_path, user_id, game_template_id, current_players_nb, max_players_slot) VALUES (1, 'Serveur Alpha', 'OFFLINE', '[IP_ADDRESS]', 25565, 'password', 'path/to/world', 0, 1, 1, 0, 10);
INSERT INTO game_servers (id, game_server_name, game_server_status, ip_adress, port, game_server_pwd, saved_world_path, user_id, game_template_id, current_players_nb, max_players_slot) VALUES (2, 'Serveur Beta', 'OFFLINE', '[IP_ADDRESS]', 25565, 'password', 'path/to/world', 0, 1, 2, 0, 10);
INSERT INTO game_servers (id, game_server_name, game_server_status, ip_adress, port, game_server_pwd, saved_world_path, user_id, game_template_id, current_players_nb, max_players_slot) VALUES (3, 'Serveur Gamma', 'OFFLINE', '[IP_ADDRESS]', 25565, 'password', 'path/to/world', 0, 1, 3, 0, 10);
